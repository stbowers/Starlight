...
namespace FinalProject.Graphics.Vulkan
{
	...
	public class VulkanShader
	{
		public struct ShaderCreateInfo
		{
			...
			/* Jagged array specifing all inputs to the shader, where
		...
		public VulkanShader(Device device, ShaderCreateInfo createInfo)
		{
			...
			moduleCreateInfo.Code = m_shaderCode;

			m_shaderModule = device.CreateShaderModule(moduleCreateInfo);
