...
namespace StarlightEngine.Graphics.Vulkan.Memory
{
    ...
    public class VmaAllocation
    {
        ...
        public IntPtr MapAllocation(long mapOffset, long mapSize)
        {
            ...
            return (mappedPtr + (int)mapOffset);
        }
    ...
    public class VulkanMemoryAllocator
    {
        ...
        public unsafe VulkanMemoryAllocator(PhysicalDevice physicalDevice, Device device)
        {
            ...
            Console.WriteLine("  Min UBO Offset allignment: {0} bytes", physicalDevice.GetProperties().Limits.MinUniformBufferOffsetAlignment);
            Console.WriteLine("  Buffer-Image granularity: {0} bytes", physicalDevice.GetProperties().Limits.BufferImageGranularity);
        ...
        public void FreeAllocation(VmaAllocation allocation)
        {
            ...
            Console.WriteLine("!!!!WARNING!!!! Attempted to free allocation that was not found - it may have been freed previously");
        }
