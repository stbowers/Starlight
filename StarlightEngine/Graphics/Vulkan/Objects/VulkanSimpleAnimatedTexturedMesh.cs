...
namespace StarlightEngine.Graphics.Vulkan.Objects
{
    public class VulkanSimpleAnimatedTexturedMesh : VulkanTexturedMesh, IAnimatedObject
    {
        ...
        public VulkanSimpleAnimatedTexturedMesh(VulkanAPIManager apiManager, string objFile, VulkanTexture texture, AnimationKeyframe[] keyframes, FMat4 view, FMat4 proj, FVec4 lightPosition, FVec4 lightColor, float ambientLight, float shineDamper, float reflectivity) :
        base(apiManager, objFile, texture, keyframes[0].Translation * keyframes[0].Rotation.GetRotationMatrix(), view, proj, lightPosition, lightColor, ambientLight, shineDamper, reflectivity)
        {
